...
public class OfficerService {
    ...
    private static final String UPLOAD_LOC = "E:/Trainning";
    ...
    /*public List<OfficerListDto> getOfficerByStationHead(String stationHeadUsername) {
        List<Officer> list = officerRepository.getOfficerByStationHead(stationHeadUsername);
        return list
                .stream()

    ...
    public class HibernateConfig {
        ...
        * */
            if(sessionFactory == null){
                ...
                configuration.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/AutomobileInsuranceSystem?createDatabaseIfNotExist=true");
                configuration.setProperty("hibernate.connection.username", "root");
                configuration.setProperty("hibernate.connection.password", "Stars@2004");
                ...
                configuration.addAnnotatedClass(InsuranceTeam.class);
